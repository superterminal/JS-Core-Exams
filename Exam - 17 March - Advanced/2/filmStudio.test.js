...
describe('testing FilmStudio', function() {
    ...
    describe('testing makeMovie', function() {
        it('testing with wrong args', function() {
            expect(() => studio.makeMovie('one')).to.throw();
        });
        it('testing with wrong args', function() {
            expect(() => studio.makeMovie(true)).to.throw();
        });
        it('testing with wrong args', function() {
            expect(() => studio.makeMovie([])).to.throw();
        });

        it('testing with wrong args', function() {
            expect(() => studio.makeMovie('one', true)).to.throw();
        });

        it('testing with wrong args', function() {
            expect(() => studio.makeMovie(1, 2)).to.throw();
        });
    ...
    describe('testing lookForProducer', function() {
        it('testing with wrong params', function() {
            expect(() => studio.lookForProducer(true)).to.throw()
        });

        it('testing with wrong params', function() {
            expect(() => studio.lookForProducer({})).to.throw()
        });

        it('testing with wrong params', function() {
            expect(() => studio.lookForProducer(1)).to.throw()
        });
